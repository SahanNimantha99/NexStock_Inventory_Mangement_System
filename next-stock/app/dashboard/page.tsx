...
export default async function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-purple-100 to-gray-50">
              ...
              {[
                ...
                <div key={idx} className="text-center">
                  ...
                  <div className="flex items-center justify-center mt-1">
                    <span className={`text-xs text-${metric.color}`}>
                      +{metric.value}
                    </span>
                    <TrendingUp
                      className={`w-3 h-3 text-${metric.color} ml-1`}
                    />
                  </div>
                </div>
              ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-white rounded-2xl shadow-md border border-gray-100 p-6 hover:shadow-lg transition-shadow duration-300">
            ...
            <div className="mt-6 space-y-2">
              {[
                {
                  label: `In Stock (${inStockPercentage}%)`,
                  color: "purple-200",
                },
                {
                  label: `Low Stock (${lowStockPercentage}%)`,
                  color: "purple-600",
                },
                {
                  label: `Out of Stock (${outOfStockPercentage}%)`,
                  color: "gray-200",
                },
              ].map((item, idx) => (
                <div
